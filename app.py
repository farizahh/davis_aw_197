...
# Query SQL untuk mengambil data order quantity dan sales amount
query_order = """
...
page = st.sidebar.selectbox("Pilih Visualisasi", ["Comparison", "Relationship", "Composition", "Distribution"])
